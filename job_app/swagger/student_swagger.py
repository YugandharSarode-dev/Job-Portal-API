...
Parameter('gender', IN_QUERY, description='gender paramater', type='char'),
...
swagger_auto_schema_post = swagger_auto_schema(
    ...
    operation_description='API to add new student request::  {}',
)
...
swagger_auto_schema_update = swagger_auto_schema(
    ...
    operation_description='API to update student',
)
