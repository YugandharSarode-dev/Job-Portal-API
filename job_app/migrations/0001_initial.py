# Generated by Django 4.1.7 on 2025-09-03 12:57
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('mobile', models.CharField(blank=True, db_index=True, max_length=16, null=True, verbose_name='mobile')),
                ...
                ('role', models.PositiveSmallIntegerField(choices=[(1, 'superuser'), (2, 'employer'), (3, 'job_seeker')], default=2)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.IntegerField(choices=[(1, 'active'), (2, 'inactive'), (3, 'deleted')], default=1)),
                ('category', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.PROTECT, to='job_app.category')),
                ('location', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.PROTECT, to='job_app.location')),
